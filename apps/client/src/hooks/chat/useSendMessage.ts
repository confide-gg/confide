...
interface UseSendMessageParams {
    ...
    sendMessageMutation: { mutateAsync: (data: SendMessageRequest) => Promise<{ created_at: string }> };
}
...
export function useSendMessage({
    ...
    const sendMessage = useCallback(async (content?: string, attachmentMeta?: AttachmentMeta) => {
    ...
    }, [activeChat, messageInput, userKeys, userId, replyTo, timedMessageDuration, friendsList, sendMessageMutation, setMessageInput, setReplyTo, setTimedMessageDuration, setIsSending, setActiveChat, setDmPreviews, messageQueuesRef]);
