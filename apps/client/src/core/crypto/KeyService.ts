...
class KeyService {
  ...
  public async initiateKeyExchange(data: InitiateKeyExchangeRequest): Promise<KeyExchangeResponse> {
  ...
  public async getSession(conversationId: string, peerId: string): Promise<SessionResponse | null> {
