              ...
              <span className={cn(
                ...
                {isLeft 
                  ? (rejoinTimeRemaining && rejoinTimeRemaining > 0 
                      ...
                      : "You left")
                  : peerHasLeft ? "Peer left" : formatDuration(duration)
                }
              </span>
            ...
            <>
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent side="bottom" className="text-xs bg-card border-border">End Call</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </>
          ) : (
            <>
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {callState.is_muted ? <MicOff className="w-4 h-4" /> : <Mic className="w-4 h-4" />}
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom" className="text-xs bg-card border-border">{callState.is_muted ? "Unmute" : "Mute"}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {callState.is_deafened ? <HeadphoneOff className="w-4 h-4" /> : <Headphones className="w-4 h-4" />}
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom" className="text-xs bg-card border-border">{callState.is_deafened ? "Undeafen" : "Deafen"}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {callState.is_screen_sharing ? <MonitorOff className="w-4 h-4" /> : <Monitor className="w-4 h-4" />}
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom" className="text-xs bg-card border-border">{callState.is_screen_sharing ? "Stop Share" : "Share Screen"}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent side="bottom" className="text-xs bg-card border-border">Expand</TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent side="bottom" className="text-xs bg-card border-border">Leave Call</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </>
          )}
