  ...
  return (
    <>
      <div className="relative w-fit max-w-md group/audio">
        <div className="relative rounded-lg overflow-hidden border border-border/50 shadow-sm bg-card/30 p-4" onContextMenu={handleContextMenu}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium text-foreground truncate">{metadata.file.name}</div>
